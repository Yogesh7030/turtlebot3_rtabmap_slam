...
#     6) Change image width/height from 1920x1080 to 320x240
# Example:
...
def launch_setup(context, *args, **kwargs):
    ...
    nav2_params_file = PathJoinSubstitution(
        [FindPackageShare('my_robot_bringup'), 'params', 'turtlebot3_rgbd_nav2_params.yaml']
    )
    ...
    rtabmap_launch = PathJoinSubstitution(
        [pkg_rtabmap, 'launch', 'turtlebot3_rgbd.launch.py'])
